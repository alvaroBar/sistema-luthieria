...
try:
    ...
    # Tabela para armazenar usuários com nome de usuário, senha e permissão (role)
    cursor.execute('''
    ...
    if cursor.fetchone() is None:
        # Cria o usuário 'admin' com a senha padrão 'admin' e permissão de 'admin'
        # Em um ambiente real, essa senha deve ser alterada imediatamente.
